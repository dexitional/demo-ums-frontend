  ...
  return (
    <div className="relative pt-6 bg-white border shadow-lg md:border-primary/30 rounded-xl flex flex-col items-center justify-center space-y-2 md:space-y-6 text-center group overflow-hidden">
      ...
      <div className="px-3 space-y-1">
        ...
        <p className="leading-5 text-sm text-primary/60 font-medium capitalize">
          {data?.department?.toLowerCase()}
        </p>
      </div>
      <Link
        to="/print/registration"
        className="px-4 py-2 bg-primary/90 text-white border shadow-lg rounded-md font-semibold tracking-wider flex items-center justify-center space-x-2"
      >
      ...
      <Link
        ...
        className="p-2.5 md:px-4 md:py-2 w-full bg-green-600 md:bg-primary/70 flex items-center justify-center space-x-3"
      >
